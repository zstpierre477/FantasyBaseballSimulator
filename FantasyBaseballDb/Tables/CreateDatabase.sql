...
CREATE TABLE BattingStint (
  ...
  OnBasePlusSlugging as OnBasePercentage+SluggingPercentage,
...
CREATE TABLE PitchingStint (
  ...
  WalksAndHitsPerInningsPitchedPlusEarnedRunAverage as WalksAndHitsPerInningsPitched + EarnedRunAverage,
