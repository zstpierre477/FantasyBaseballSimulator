...
namespace FantasyBaseball.Repository
{
    public interface IBattingStintRepository
    {
        ...
        IEnumerable<PlayerStint> GetBattingStintByPositionYearMinimumGamesPlayedAndMinimumAtBats(string position, int year, int minimumGamesPlayed, int minimumAtBats);
    }
}
